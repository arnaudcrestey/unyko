  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-ink px-6 text-center">
      ...
      <div className="relative z-10 flex max-w-3xl flex-col items-center">
        ...
        <Logo />
        <h1 className="mt-10 font-serif text-6xl leading-none text-ivory md:text-8xl">Mesurer la recommandabilité.</h1>
        <p className="mt-8 max-w-xl text-base leading-8 text-ivory/65 md:text-lg">
          UNYKO révèle ce qui rend une organisation visible, lisible, crédible, présente, autoritaire et recommandable.
        </p>
      </div>
    </main>
  );
