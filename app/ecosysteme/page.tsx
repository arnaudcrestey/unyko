  ...
  return (
    <PageShell>
      <section className="mx-auto max-w-7xl px-5 py-24 lg:px-8">
        <SectionHeader eyebrow="Écosystème" title="SYSTIA, ARHI et UNYKO clarifient trois dimensions de l'organisation." text="SYSTIA rend l'activité pilotable. ARHI rend les rôles et décisions lisibles. UNYKO mesure ce qui rend une organisation visible, crédible et recommandable à l'ère de l'IA." />
