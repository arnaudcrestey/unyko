    ...
    <section className="mx-auto max-w-7xl px-5 py-20 lg:px-8">
      <div className="premium-card relative overflow-hidden rounded-[2.5rem] p-8 text-center md:p-14">
        ...
        <div className="relative mx-auto max-w-3xl">
          ...
          <h2 className="mt-5 font-serif text-4xl leading-none text-ivory md:text-6xl">Rendre votre recommandabilité lisible.</h2>
          <p className="mt-6 text-base leading-8 text-ivory/60">
            Lancez une lecture structurée de votre visibilité, de votre lisibilité, de votre crédibilité, de votre présence et de votre autorité.
          </p>
