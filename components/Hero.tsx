    ...
    <section className="relative mx-auto grid min-h-[82vh] max-w-7xl items-center gap-14 px-5 py-20 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
      <div className="relative z-10">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row">
          ...
          <ButtonLink href="/vitrine" variant="secondary">
            Voir la page signature
          </ButtonLink>
        </div>
      </div>
      ...
      <div className="relative mx-auto w-full max-w-[520px]">
        ...
        <div className="premium-card absolute left-1/2 top-1/2 w-[72%] -translate-x-1/2 -translate-y-1/2 rounded-full p-8 text-center">
          ...
          <p className="mt-2 text-xs uppercase tracking-[0.34em] text-ivory/55">
            Indice UNYKO
          </p>

          <p className="mt-5 text-sm leading-6 text-ivory/60">
            Un indice propriétaire de recommandabilité organisationnelle à
            l&apos;ère de l&apos;IA.
          </p>
        </div>
      </div>
